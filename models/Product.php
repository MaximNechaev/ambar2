...
class Product
{
    ...
    public static function getProductById($id)
    {
        ...
        public static function getCommentsById($id)
        {
            ...
            // Текст запроса к БД
            $sql = 'SELECT name, text, post_date, user_id FROM comment, user WHERE product_id = :id AND user.id = comment.user_id ORDER BY post_date DESC';
    ...
    public static function getProductsList()
    {
        ...
        $result = $db->query('SELECT id, name, price, code FROM product WHERE seller_id='.$user['id'].' ORDER BY id ASC');
    }
    ...
    public static function createProduct($options)
    {
        ...
        $sql = 'INSERT INTO product '
                ...
                . 'description, is_new, is_recommended, status, seller_id)'
                . 'VALUES '
                . '(:name, :code, :price, :category_id, :brand, :availability,'
                . ':description, :is_new, :is_recommended, :status, :seller_id)';
    ...
    public static function createComment($options){
        ...
        $sql = 'INSERT INTO comment '
                . '(product_id, user_id, text, post_date)'
                . 'VALUES '
                . '(:product_id, :user_id, :text, :post_date)';
        ...
        // Получение и возврат результатов. Используется подготовленный запрос
        $result = $db->prepare($sql);
        $result->bindParam(':product_id', $options['product_id'], PDO::PARAM_STR);
        $result->bindParam(':user_id', $options['user_id'], PDO::PARAM_STR);
        $result->bindParam(':text', $options['text'], PDO::PARAM_INT);
        $result->bindParam(':post_date', $options['post_date'], PDO::PARAM_STR);
